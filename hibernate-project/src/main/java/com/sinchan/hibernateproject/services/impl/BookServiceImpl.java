...
//				.orElseThrow(() -> new ResourceNotFoundException("Book", "bookName", bookName));
//		return this.modelMapper.map(book, BookDto.class);
//	}
//
//	@Override
...
//				.orElseThrow(() -> new ResourceNotFoundException("Book", "bookAuthor", bookAuthor));
//		return this.modelMapper.map(book, BookDto.class);
//	}
//
//	@Override
...
//				.orElseThrow(() -> new ResourceNotFoundException("Book", "bookPublication", bookPublication));
//		return this.modelMapper.map(book, BookDto.class);
//	}
//
//	@Override
...
//				.orElseThrow(() -> new ResourceNotFoundException("Book", "bookPublicationYear", bookPublicationYear));
//		return this.modelMapper.map(book, BookDto.class);
//	}
//
	@Override
